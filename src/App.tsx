...
const App: React.FC = () => {
  ...
  const changeSeaLevel = (level: number) => {
    threeCtrl.current!.changeSeaLevel(level);
  };

  const getCameraController = () => {
    return threeCtrl.current!.cameraController;
  };
    ...
    <>
      ...
      <div className={`${styles.wrapper} ${inMap ? styles.noEvents : ""}`}>
        ...
        <div className={styles.footer}>
          ...
          >
            <svg
              className={styles.spaceapps}
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 209.88 83.76"
            >
              <path
                fill="#FFF"
